...
<body>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="contactModalLabel">Thêm Student</h5>
    ...
    <script>
        ...
        async function loadContacts(page = 1) {
            showLoading(true);
            try {
                const response = await fetch(`/api/student?paginated=true&per_page=6&page=${page}`);
        ...
        async function searchStudents() {
            ...
            showLoading(true);
            try {
                const response = await fetch(`/api/student/search?q=${encodeURIComponent(keyword)}&paginated=true&per_page=6`);
                const data = await response.json();
                if (data.status === 'success') {
                    displayContacts(data.data);
                    displayPagination(data.pagination);
        ...
        async function saveStudent() {
            ...
            const url = isEdit ? `/api/student/${contactData.id}` : '/api/student';
        ...
        async function confirmDelete() {
            ...
            try {
                const response = await fetch(`/api/student/${deleteContactId}`, {
                    method: 'DELETE',
                    headers: {
